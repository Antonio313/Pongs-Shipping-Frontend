...
function PackagesTab({ userRole, canChangeStatus }) {
              ...
              >
                ...
                <div className="flex gap-2 pt-2 border-t border-gray-100">
                  <button
                    ...
                    className={`${canChangeStatus ? 'flex-1' : 'w-full'} bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold py-2 px-3 rounded-lg transition-all duration-300 flex items-center justify-center gap-2`}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function PackageDetailsModal({ package: pkg, onClose, onStatusUpdate, onDelete, getStatusBadge, formatDate, canChangeStatus }) {
