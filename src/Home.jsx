...
function LocationShowcaseComponent({ selectedLocation, locations }) {
  ...
  return (
    <div className="w-full h-full relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl overflow-hidden">
      ...
      {/* Main Content */}
      <div className={`relative z-10 h-full flex flex-col justify-center p-8 transition-all duration-600 ${isAnimating ? 'opacity-0 transform translate-y-4' : 'opacity-100 transform translate-y-0'}`}>

        {/* Location Header */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full mb-6 shadow-2xl transform hover:scale-110 transition-transform duration-300">
            <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
          </div>
          <h3 className="text-3xl font-bold text-gray-800 mb-2 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text">
            {currentLocation.name}
          </h3>
          <p className="text-lg text-gray-600 mb-4">{currentLocation.address}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          {/* Contact Information */}
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20 transform hover:scale-105 transition-all duration-300">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-green-600 font-semibold">{currentLocation.phone}</p>
              </div>
            </div>
            <a
              href={`tel:${currentLocation.phone}`}
              className="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 block text-center"
            >
              Call Now
            </a>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20 transform hover:scale-105 transition-all duration-300">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-blue-600 font-semibold">{currentLocation.hours}</p>
              </div>
            </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 max-w-lg mx-auto">
          <a
            ...
            className="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center"
          >
          ...
          <a
            ...
            className="flex-1 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-medium py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center"
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center mt-6">
          <div className="inline-flex items-center px-4 py-2 bg-green-100 text-green-800 rounded-full text-sm font-medium">
            ...
            Currently Open & Accepting Packages
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                {Object.entries(locations).map(([key, location]) => (
                  ...
                  >
                    ...
                    <p className={`mb-3 ${selectedLocation === key ? 'text-blue-100' : 'text-gray-600'}`}>
                      {location.address}
                    </p>
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                  ...
                  <div className="relative h-80 rounded-b-2xl overflow-hidden">
